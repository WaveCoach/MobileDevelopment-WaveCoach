...
Color circleBarBlueColor = Color(0xFF89B5D9);
Color fadeBlueColor = Color(0xFF9EB2C2);
Color greyColor = Color.fromARGB(255, 48, 48, 48);
Color fadeYellowColor = Color(0xFFEDC892);
Color blackBlueColor = Color(0xFF223340);
